...
void help_page3(int (*a)[8])
{
    ...
    puthz(0, 46, "用户可在单向思维导图、树状图、鱼骨图编辑界面进行以下操作：", 16, 16, BLACK);
    ...
    puthz(0, 46 + 22 * 8, "单向思维导图、树状图可改变框色，字色：", 16, 16, BLACK);
    puthz(14 * 16, 46 + 22 * 9, "选中框后进入标红状态，点击颜色，选择", 16, 16, BLACK);
    puthz(14 * 16 + 18 * 16, 46 + 22 * 9, "框色", 16, 16, RED);
    puthz(14 * 16 + 20 * 16, 46 + 22 * 9, "或", 16, 16, BLACK);
    puthz(14 * 16 + 21 * 16, 46 + 22 * 9, "字色", 16, 16, RED);
    puthz(14 * 16 + 23 * 16, 46 + 22 * 9, "即可", 16, 16, BLACK);
    puthz(0, 46 + 22 * 10, "用户在时间轴编辑界面可进行以下操作：", 16, 16, BLACK);
    setcolor(RED);
    puthz(14 * 16, 46 + 22 * 11, "输入正确格式年月日时间及内容点击新增，", 16, 16, BLACK); //蓝绿红黑
    puthz(14 * 16 + 19 * 16, 46 + 22 * 11, "新增", 16, 16, RED);
    puthz(14 * 16 + 21 * 16, 46 + 22 * 11, "时间轴框", 16, 16, BLACK);
    puthz(14 * 16, 46 + 22 * 12, "选中导图框进入标红状态，点击", 16, 16, BLACK);
    puthz(14 * 16 + 14 * 16, 46 + 22 * 12, "删除", 16, 16, RED);
    puthz(14 * 16 + 16 * 16, 46 + 22 * 12, "对应框", 16, 16, BLACK);
    puthz(14 * 16, 46 + 22 * 13, "导图中", 16, 16, BLACK);
    puthz(14 * 16 + 3 * 16, 46 + 22 * 13, "蓝色", 16, 16, BLUE);
    puthz(14 * 16 + 5 * 16, 46 + 22 * 13, "对应年份，", 16, 16, BLACK);
    puthz(14 * 16 + 10 * 16, 46 + 22 * 13, "绿色", 16, 16, GREEN);
    puthz(14 * 16 + 12 * 16, 46 + 22 * 13, "对应月份，", 16, 16, BLACK);
    puthz(14 * 16 + 17 * 16, 46 + 22 * 13, "红色", 16, 16, RED);
    puthz(14 * 16 + 19 * 16, 46 + 22 * 13, "对应天", 16, 16, BLACK);
    puthz(0, 46 + 22 * 16, "点击", 16, 16, BLACK);
    puthz(2 * 16, 46 + 22 * 16, "完成", 16, 16, RED);
    puthz(4 * 16, 46 + 22 * 16, "后退出编辑页面", 16, 16, BLACK);
